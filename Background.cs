...
namespace FlappyDolphin
{
	...
	{	
		...
		public Background (Scene scene)
		{
			...
			textureInfo  		= new TextureInfo("/Application/textures/sea_Background.jpg");
			//Left
			...
			//Position pipes.
			sprites[0].Position = new Vector2(0.0f, 90.0f);
			
			sprites[1].Position = new Vector2(sprites[0].Position.X+width, 90.0f);
			
			sprites[2].Position = new Vector2(sprites[1].Position.X+width, 90.0f);
